                        ...
                        <div class="col-8 d-flex mb-2">
                            ...
                            <div class="dropdown ml-2">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="actionDropdownFilter">
                                    <li><a class="dropdown-item" href="{{ route('backend.blogs.categories.list') }}">Reset filter</a></li>
                                    ...
                                    <li class="dropdown-submenu filter__sort-by">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item filter__sort-by--option" data-sort-by="alias" href="#">Alias</a></li>
                                        </ul>
                                    </li>
